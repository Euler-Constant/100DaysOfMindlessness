...
This might as well be speculation (Probably all just speculation), but I thought of increasing the attack surface for the ransomware while working on the model today and I got to get an interesting perspective on the attack range:
